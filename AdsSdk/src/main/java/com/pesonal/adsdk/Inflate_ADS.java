...
public class Inflate_ADS {
    ...
    public void inflate_NB_FB(NativeBannerAd nativeBannerAd, ViewGroup cardView) {
        ...
        try {
            nativeAdCallToAction.setTextColor(ColorStateList.valueOf(Color.parseColor("#" + mysharedpreferences.getString("CTA_Buttton_TextColor", ""))));
            nativeAdCallToAction.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#" + mysharedpreferences.getString("CTA_Buttton_Color", ""))));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void inflate_NATIV_ADMOB_SMALL(com.google.android.gms.ads.nativead.NativeAd nativeAd, ViewGroup cardView) {
        ...
        try {
            ((TextView) adView.findViewById(R.id.ad_call_to_action)).setTextColor(ColorStateList.valueOf(Color.parseColor("#" + mysharedpreferences.getString("CTA_Buttton_TextColor", ""))));
            adView.findViewById(R.id.ad_call_to_action).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#" + mysharedpreferences.getString("CTA_Buttton_Color", ""))));
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//       adView.getMediaView().setMediaContent(nativeAd.getMediaContent());
    ...
    //TODo Hiral Big Native Advanced
    public void inflate_NATIV_ADMOB_BIG(com.google.android.gms.ads.nativead.NativeAd nativeAd, ViewGroup cardView) {

        cardView.setVisibility(View.VISIBLE);
        LayoutInflater inflater = LayoutInflater.from(activity);

        View view = inflater.inflate(R.layout.ads_nativ_admob_big, null);
        cardView.removeAllViews();
        cardView.addView(view);
